...
{	
	...
	*/
	...
	if(DK_Id(event, "Craigslist")){
		...
		DK_QueueDuktape("DKCef_SetUrl('DKBrowser_cef', DKCef_GetCurrentBrowser('DKBrowser_cef'), 'https://"+buySettings.craigslistLocation+".craigslist.org/d/for-sale/search/sss');");
	}
